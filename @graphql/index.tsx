...
export type Features = {
  ...
  autoburn: Scalars['Boolean'];
  autoburnTs?: Maybe<Scalars['Int']>;
};
...
export type Features_Filter = {
  ...
  autoburn?: Maybe<Scalars['Boolean']>;
  autoburn_not?: Maybe<Scalars['Boolean']>;
  autoburn_in?: Maybe<Array<Scalars['Boolean']>>;
  autoburn_not_in?: Maybe<Array<Scalars['Boolean']>>;
  autoburnTs?: Maybe<Scalars['Int']>;
  autoburnTs_not?: Maybe<Scalars['Int']>;
  autoburnTs_gt?: Maybe<Scalars['Int']>;
  autoburnTs_lt?: Maybe<Scalars['Int']>;
  autoburnTs_gte?: Maybe<Scalars['Int']>;
  autoburnTs_lte?: Maybe<Scalars['Int']>;
  autoburnTs_in?: Maybe<Array<Scalars['Int']>>;
  autoburnTs_not_in?: Maybe<Array<Scalars['Int']>>;
};
...
export type Token_Filter = {
  ...
  navFeePaid?: Maybe<Scalars['Int']>;
  navFeePaid_not?: Maybe<Scalars['Int']>;
  navFeePaid_gt?: Maybe<Scalars['Int']>;
  navFeePaid_lt?: Maybe<Scalars['Int']>;
  navFeePaid_gte?: Maybe<Scalars['Int']>;
  navFeePaid_lte?: Maybe<Scalars['Int']>;
  navFeePaid_in?: Maybe<Array<Scalars['Int']>>;
  navFeePaid_not_in?: Maybe<Array<Scalars['Int']>>;
  kyaUri?: Maybe<Scalars['String']>;
...
export type ContributedFundraiserFragment = (
  { __typename?: 'Fundraiser' }
  & Pick<Fundraiser, 'status' | 'supply' | 'tokenPrice' | 'amountQualified'>
  & { token: (
    { __typename?: 'Token' }
    & TokenInfoFragment
  ), baseCurrency: (
    { __typename?: 'Erc20Token' }
    & Pick<Erc20Token, 'decimals'>
  ) }
);
...
export type ContributionsQuery = (
  ...
  & { contributors: Array<(
    { __typename?: 'Contributor' }
    & Pick<Contributor, 'amount' | 'amountClaimed' | 'status'>
    & { fundraiser: (
      { __typename?: 'Fundraiser' }
...
export type PublicTokensQueryVariables = Exact<{ [key: string]: never; }>;


export type PublicTokensQuery = (
  { __typename?: 'Query' }
  & { tokens: Array<(
    { __typename?: 'Token' }
    & TokenFragment
  ...
  & { tokenHolders: Array<(
    ...
    & { token: (
      ...
      & { whitelist: Array<(
        ...
        { __typename?: 'Features' }
        & Pick<Features, 'autoburn' | 'autoburnTs'>
      )> }
      & TokenInfoFragment
    ) }
    & TokenHolderFragment
...
export const TokenInfoFragmentDoc = gql`
  ...
  features {
    ...
    `;
export const ContributedFundraiserFragmentDoc = gql`
...
/**
 * __useContributionsQuery__
 *
 * To run a query within a React component, call `useContributionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useContributionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useContributionsQuery({
 *   variables: {
 *      address: // value for 'address'
 *   },
 * });
 */
export function useContributionsQuery(baseOptions?: Apollo.QueryHookOptions<ContributionsQuery, ContributionsQueryVariables>) {
        return Apollo.useQuery<ContributionsQuery, ContributionsQueryVariables>(ContributionsDocument, baseOptions);
      }
export function useContributionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ContributionsQuery, ContributionsQueryVariables>) {
          return Apollo.useLazyQuery<ContributionsQuery, ContributionsQueryVariables>(ContributionsDocument, baseOptions);
        }
export type ContributionsQueryHookResult = ReturnType<typeof useContributionsQuery>;
export type ContributionsLazyQueryHookResult = ReturnType<typeof useContributionsLazyQuery>;
export type ContributionsQueryResult = Apollo.QueryResult<ContributionsQuery, ContributionsQueryVariables>;
...
export const PublicTokensDocument = gql`
    query PublicTokens {
  tokens {
    ...Token
  }
...
/**
 * __usePublicTokensQuery__
 *
 * To run a query within a React component, call `usePublicTokensQuery` and pass it any options that fit your needs.
 * When your component renders, `usePublicTokensQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePublicTokensQuery({
 *   variables: {
 *   },
 * });
 */
export function usePublicTokensQuery(baseOptions?: Apollo.QueryHookOptions<PublicTokensQuery, PublicTokensQueryVariables>) {
        return Apollo.useQuery<PublicTokensQuery, PublicTokensQueryVariables>(PublicTokensDocument, baseOptions);
      }
export function usePublicTokensLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PublicTokensQuery, PublicTokensQueryVariables>) {
          return Apollo.useLazyQuery<PublicTokensQuery, PublicTokensQueryVariables>(PublicTokensDocument, baseOptions);
        }
export type PublicTokensQueryHookResult = ReturnType<typeof usePublicTokensQuery>;
export type PublicTokensLazyQueryHookResult = ReturnType<typeof usePublicTokensLazyQuery>;
export type PublicTokensQueryResult = Apollo.QueryResult<PublicTokensQuery, PublicTokensQueryVariables>;
